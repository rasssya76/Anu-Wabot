...
cmd.on('menu-cmd', ['menu','help','command','commands'], [], async (msg, {
  ...
  "listMessage": {
   ...
   let buttonsMessage = {
        contentText: hasil,
        footerText: `© Powered by RamZXTeam7`,
        locationMessage,
        buttons,
        headerType: "LOCATION"
    }
